...
@ContextConfiguration(classes = arrayOf(JdbcDataSourceConfig::class, PostgresqlRepository::class, JdbcMetaDataRepository::class, Storage::class, MessagePackTransporter::class))
